...
export default function IconButton({ icon: Icon, color, onClick, disabled = false, size = IconSize.DEFAULT, className = "" }: IconButtonProps) {
    ...
    return (
        <button
            ...
            style={{
                ...
                backgroundColor: !disabled && hovered ? `color-mix(in srgb, ${color} 12%, transparent)` : 'transparent',
            }}
